...
import com.example.loveandcare.Adapters.OrderDetailsAdapter;
import com.example.loveandcare.Items.OrderItems;
...
public class OrderDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = firebaseFirestore.collection("Customer").
                document("Orders").collection(user_id).
